...
function reveal() {
  document.getElementById('merrywrap').style.backgroundImage = 'none'
  document.querySelector('.merrywrap').style.backgroundImage = 'none';  
  player.play()
  letter_container.style.left = '20%'
  ...
  const ifrm = document.createElement("video");
  ifrm.src = 'imgs/vid1.mp4'
